...
export default function DesktopNav() {
  return (
    <div className="sidebar bg-blue-800 text-blue-100 w-48 space-y-6 px-2 py-7 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out">
